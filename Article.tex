...
\caption{Model is able to classify multiple replay types. \textbf{a.} Continuous. \textbf{b.} Hover. \textbf{c.} Fragmented. \textbf{d.} Hover-Continuous-Hover. \textbf{e.} Fragmented-Continuous-Hover. \textbf{f.} Fragmented-Hover-Fragmented.}
\label{fig:computerNo}
\end{figure}
